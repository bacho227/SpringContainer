...
//            if (directLink != null)
            response.getWriter()
                    .append("<html><body><center style=\"font-size:15px;margin-top:50px;\">გაიარეთ ავტორიზაია!</center></body></html>");
            return null;
        }
        return user;
    }
...
//            if (directLink != null)
            response.getWriter()
                    .write("<html><body><center style=\"font-size:15px;margin-top:50px;\">არ გაქვთ უფლება!</center></body></html>");
        }
